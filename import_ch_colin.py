...
# Colin's changes: I've added 'Type', 'Info Source for Owner' and 'Info Source for Operator' to ma, then deleted 'Info Source for owner-operator' and
# commented out 'City', 'State' and 'Additional Info' in ma. Then commented out references to City, State, etc. on lines 240 and 241
...
ma = {
      ...
      'Type':				 {'dbfmt': "'%s'",  'dbname': 'type',		'dbtype':  'varchar(100)'},
      ...
      'Info Source for Owner':  	 {'dbfmt': "'%s'",  'dbname': 'ch_build_owner_src',  'dbtype':  'varchar(512)'},
      'Info Source for Operator': 	 {'dbfmt': "'%s'",  'dbname': 'ch_operator_src',     'dbtype':  'varchar(512)'},
...
#ss_cols = ['NSA', 'Type', 'NSA Info Source',      'CH Owner of Building', 'CH Operator', 'CH Info Source', 'Lat',
